...
<body class="bg-slate-100 text-slate-900 pb-12 pt-6">
    <div class="max-w-3xl mx-auto bg-white p-8 sm:p-12 shadow-xl print-border relative">
        ...
        <div class="text-center border-b-4 border-emerald-800 pb-6 mb-8">
            <h1 class="text-3xl font-black uppercase text-emerald-900 tracking-wider">BUKTI PENDAFTARAN</h1>
            ...
            <p class="text-xs text-slate-500 mt-2">Waktu Daftar: {{ $santri->created_at->format('d/m/Y H:i:s') }}</p>
        </div>

        <div class="mb-4 bg-emerald-50 text-emerald-800 px-4 py-3 border border-emerald-200 rounded font-bold text-center">
            STATUS: <span class="uppercase">{{ $santri->status_pendaftaran }}</span>
        </div>
        ...
        <div class="mt-12 flex justify-between">
            <div class="text-center">
                <p class="text-sm">Panitia Pendaftaran,</p>
                <br><br><br>
        ...
        <p class="text-xs text-center mt-12 text-slate-400 no-print">Dokumen ini sah dan dicetak secara otomatis melalui Sistem Pendaftaran Cerdas (AI).</p>
    </div>
    <script>

...
<body>
            ...
            <div class="signature-box">
                ...
                <div class="signature-space">
                    @if($santri->tanda_tangan)
                        <img src="{{ public_path('storage/' . $santri->tanda_tangan) }}" class="ttd-img">
                    @else
    ...
    <div class="container">
        ...
        <div style="display:table; width:100%; text-align:center; margin-bottom:20px; border-bottom: 0.5pt solid #000; padding-bottom: 15px;">
            <div style="display:table-cell; width:20%">
                @if($santri->foto_pas_siswa)
                    <img src="{{ public_path('storage/' . $santri->foto_pas_siswa) }}" style="width:3cm; height:4cm; border:0.5pt solid #000">
            ...
            <div style="display:table-row">
                <div style="display:table-cell; width:50%; padding:10px; text-align:center">
                    ...
                    @if($santri->foto_ktp_ayah)
                        <img src="{{ public_path('storage/' . $santri->foto_ktp_ayah) }}" class="document-image">
                    @else
                ...
                <div style="display:table-cell; width:50%; padding:10px; text-align:center">
                    ...
                    @if($santri->foto_ktp_ibu)
                        <img src="{{ public_path('storage/' . $santri->foto_ktp_ibu) }}" class="document-image">
                    @else
                        <div style="height:100px; border:0.5pt dashed #ccc; padding-top:40px; font-size:8pt; color:#666;">Berkas tidak tersedia</div>
                    @endif
                </div>
        ...
        <div style="margin-top:20px; text-align:center; border-top: 0.5pt dashed #ccc; padding-top:15px;">
            ...
            @if($santri->foto_kk)
                <img src="{{ public_path('storage/' . $santri->foto_kk) }}" style="width:100%; max-height:450px; border:0.5pt solid #000">
            @else
        ...
        <div class="container">
            ...
            <div style="margin-top:10px; text-align:center;">
                ...
                @if($santri->foto_akta_anak)
                    <img src="{{ public_path('storage/' . $santri->foto_akta_anak) }}" style="width:100%; max-height:750px; border:0.5pt solid #000">
                @else
